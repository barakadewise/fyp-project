...
export class OpportunityResolver {
  ...
  async createOpportunity(
    @Args('createOpportunityInput') createOpportunityInput: OpportunityDto,
  ): Promise<Opportunity> {
    return await this.opprtunityService.createOpportunity(
  ...
  async updateOpportunity(
    @Args('opportunityId') opptunityId: number,
    @Args('updateOpportunityDto') updateOpportunityDto: UpdateOpportunityDto,
  ) {
    return await this.opprtunityService.updateOpportunity(
      opptunityId,
